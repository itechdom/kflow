...
const theme2Light = {
  ...
  // Light Mode
const theme3Light = {
    background: "linear-gradient(to top, #EEEEEE 0%, #FFFFFF 100%)", // Light Gray to White
    baseStyle: { fill: "#FFFFFF", stroke: "#212121" }, // White with Black Outline
    textColor: "#212121", // Black
    nodeStyles: {
      blueNode: { fill: "#BDBDBD" },    // Gray
      orangeNode: { fill: "#757575" },  // Dark Gray
      greyNode: { fill: "#424242" },   // Darker Gray
      customNode: { fill: "#9E9E9E" }, // Medium Gray
    },
  };
  ...
  export { theme1Light, theme1Dark, theme2Light, theme2Dark, theme3Light, theme3Dark}